  ...
  <div class="sidebar">
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu"
        ...
        <li class="nav-item dropdown">
          <a href="./index.php?page=subject_course_mapping" class="nav-link nav-subject_course_mapping">
        ...
        <li class="nav-item dropdown">
          <a href="./index.php?page=manage_irregular_subjects" class="nav-link nav-manage_irregular_subjects">
