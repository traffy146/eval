...
if ($action == 'bulk_update_students') {
	$save = $crud->bulk_update_students();
	echo $save;
}
if ($action == 'save_subject_mapping') {
	$save = $crud->save_subject_mapping();
	if ($save)
		echo $save;
}
if ($action == 'delete_subject_mapping') {
	$save = $crud->delete_subject_mapping();
	if ($save)
		echo $save;
}
if ($action == 'auto_assign_subjects') {
	$save = $crud->auto_assign_subjects();
	if ($save)
		echo $save;
}
if ($action == 'add_irregular_subject') {
	$save = $crud->add_irregular_subject();
	if ($save)
		echo $save;
}
if ($action == 'get_irregular_subjects') {
	$get = $crud->get_irregular_subjects();
	if ($get)
		echo $get;
}
if ($action == 'remove_irregular_subject') {
	$save = $crud->remove_irregular_subject();
	if ($save)
		echo $save;
}
if ($action == 'get_class') {
...
if ($action == 'get_overall_report') {
	$get = $crud->get_overall_report();
	if ($get)
		echo $get;
}
if ($action === 'get_additional_feedback') {
	$get = $crud->get_additional_feedback();
	if ($get)
		echo $get;
}
