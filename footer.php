...
<script>
	...
	window.makeTablesResponsive = function (scope) {
	...
	window.makeTablesResponsive(document)
		...
		$.ajax({
			...
			success: function (resp) {
				if (resp) {
					...
					if (window.makeTablesResponsive) {
						window.makeTablesResponsive('#uni_modal .modal-body')
					}
					if ($size != '') {
